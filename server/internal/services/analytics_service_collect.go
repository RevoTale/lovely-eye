...
func (s *AnalyticsService) acceptedAnalyticsSite(
	ctx context.Context,
	siteKey string,
	userAgent string,
	origin string,
...
func (s *AnalyticsService) collectCountry(site *models.Site, ip string, enabled bool) Country {
...
func (s *AnalyticsService) collectPageViewTx(
	ctx context.Context,
	tx bun.Tx,
	siteID int64,
	input CollectInput,
...
func (s *AnalyticsService) resolvePageViewClient(
	ctx context.Context,
	tx bun.Tx,
	siteID int64,
	input CollectInput,
...
func (s *AnalyticsService) activeSessionTx(
	ctx context.Context,
	tx bun.Tx,
	siteID int64,
	clientID int64,
...
func (s *AnalyticsService) applyPageViewSessionTx(
	ctx context.Context,
	tx bun.Tx,
	siteID int64,
	clientID int64,
...
func (s *AnalyticsService) createPageViewSessionTx(
	ctx context.Context,
	tx bun.Tx,
	siteID int64,
	clientID int64,
...
func (s *AnalyticsService) updatePageViewSessionTx(
	ctx context.Context,
	tx bun.Tx,
	input CollectInput,
	session *models.Session,
...
func (s *AnalyticsService) applyDuplicatePageViewTx(
	ctx context.Context,
	tx bun.Tx,
	input CollectInput,
	session *models.Session,
...
func (s *AnalyticsService) updateSessionTx(ctx context.Context, tx bun.Tx, session *models.Session, label string) error {
...
func (s *AnalyticsService) insertPageViewEventTx(
	ctx context.Context,
	tx bun.Tx,
	sessionID int64,
	path string,
...
func (s *AnalyticsService) CollectEvent(ctx context.Context, input EventInput) error {
	...
	if !accepted || s.eventDefinitionRepo == nil {
		return nil
	}
...
func (s *AnalyticsService) eventDefinitionForCollect(
	ctx context.Context,
	siteID int64,
	input EventInput,
) (*models.EventDefinition, string, bool, error) {
	definition, err := s.eventDefinitionRepo.GetByName(ctx, siteID, input.Name)
	if errors.Is(err, sql.ErrNoRows) {
		return nil, "", false, nil
	}
	if err != nil {
...
func (s *AnalyticsService) collectEventTx(
	ctx context.Context,
	tx bun.Tx,
	siteID int64,
	input EventInput,
	...
	now time.Time,
	nowUnix int64,
	definition *models.EventDefinition,
...
func (s *AnalyticsService) eventSessionTx(
	ctx context.Context,
	tx bun.Tx,
	siteID int64,
	clientID int64,
...
func (s *AnalyticsService) createEventSessionTx(
	ctx context.Context,
	tx bun.Tx,
	siteID int64,
	clientID int64,
...
func (s *AnalyticsService) insertCustomEventTx(
	ctx context.Context,
	tx bun.Tx,
	sessionID int64,
	path string,
...
func (s *AnalyticsService) insertCustomEventDataTx(
	ctx context.Context,
	tx bun.Tx,
	eventID int64,
	sanitizedProps string,
