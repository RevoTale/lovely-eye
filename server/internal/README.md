...
- `./config` - Application configuration loader. Reads environment variables for server, database, auth, analytics identity, collect limits, single-page duration caps, trusted proxies, GraphQL body limits, and dashboard query caps.
