...
export type ChartDataQuery = { __typename: 'Query', dashboard: { __typename: 'DashboardStats', dailyStats: Array<{ __typename: 'DailyStats', date: string, visitors: number, pageViews: number, sessions: number }> } };
