...
import { DangerZoneCard } from '@/features/site-settings/ui/danger-zone-card';
import { DeleteSiteDocument, SitesDocument } from '@/shared/api/generated/graphql';
...
export const DangerZoneSection = ({ siteId, onDeleted }: DangerZoneSectionProps): ReactElement => {
