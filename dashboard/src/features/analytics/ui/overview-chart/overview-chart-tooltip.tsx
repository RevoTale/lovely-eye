...
import { buildTimeFormatter } from '@/features/analytics/model/chart-date';
import { formatOverviewValue } from '@/features/analytics/ui/overview-chart/overview-chart-formatters';
import {
...
const OverviewChartTooltip: FunctionComponent<OverviewChartTooltipProps> = ({
  active,
  bucket,
  label,
  payload,
  ...
  return (
    <div className='min-w-[180px] rounded-xl border border-border/70 bg-background/96 px-3 py-2 text-xs shadow-xl backdrop-blur-sm'>
      <div className='mb-2 border-b border-border/70 pb-2 font-medium text-foreground'>
