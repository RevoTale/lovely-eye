...
import { formatOverviewAxisTickLines } from '@/features/analytics/ui/overview-chart/overview-chart-axis';

interface OverviewChartXAxisTickProps extends XAxisTickContentProps {
  bucket: 'daily' | 'hourly';
}

const OverviewChartXAxisTick: FunctionComponent<OverviewChartXAxisTickProps> = ({
  bucket,
  payload,
  x = 0,
  y = 0,
