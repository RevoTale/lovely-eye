...
import BrowserCard from '@/features/analytics/ui/browser-card';
import DevicesCard from '@/features/analytics/ui/devices-card';
import OSCard from '@/features/analytics/ui/os-card';
import type {
...
const AnalyticsPlatformBreakdownSection: FunctionComponent<
  AnalyticsPlatformBreakdownSectionProps
> = (props) => (
  <div className='grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3'>
    ...
    <DevicesCard
      ...
      total={props.devicesTotal}
      totalVisitors={props.devicesTotalVisitors}
      page={props.devicesPage}
      pageSize={props.devicesPageSize}
      siteId={props.siteId}
      state={props.dashboardState}
      onPageChange={props.onDevicesPageChange}
    />
    <OSCard
      operatingSystems={props.operatingSystems}
      total={props.operatingSystemsTotal}
      totalVisitors={props.operatingSystemsTotalVisitors}
      page={props.osPage}
      pageSize={props.osPageSize}
      siteId={props.siteId}
      state={props.dashboardState}
      onPageChange={props.onOSPageChange}
    />
  </div>
);
